...
function ProjectScreen({
  ...
  const exportToPDF = () => {
    ...
    // 🔥 Title
    doc.setFontSize(16);
    doc.text(`Project: ${selectedProject.name}`, 10, 15);
    ...
    // 🔥 Table
    autoTable(doc, {
      head: [['Date', 'Time', 'Type', 'Amount', 'Category', 'Party']],
      body: tableData,
      startY: 25,
      styles: {
        fontSize: 10,
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: 10 }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button
            onClick={async () => {
              const newStatus =
                selectedProject.status === 'active' ? 'finished' : 'active';
            ...
            style={{
              ...
              border: 'none',
              background:
                selectedProject.status === 'active' ? '#f59e0b' : '#16a34a',
              color: '#fff',
              cursor: 'pointer',
            }}
          >
            {selectedProject.status === 'active' ? 'Finish' : 'Resume'}
          </button>
        </div>
      </div>
      ...
      >
        ...
        >
          <div
            style={{
              fontSize: 12,
              color: theme.background === '#121212' ? '#111' : '#333',
              fontWeight: 500,
            }}
          >
            Cash In
      ...
      {/* 🔥 TRANSACTIONS */}
      <h3 style={{ marginTop: 20, marginBottom: 10 }}>Transactions</h3>
      ...
      {showForm && (
        ...
        >
          ...
          >
            <h3 style={{ marginBottom: 15 }}>Add Transaction</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <span
                  style={{
                    fontSize: 12,
                    color: form.type === 'cash_out' ? 'red' : '#888',
                    fontWeight: form.type === 'cash_out' ? 600 : 400,
                  }}
                >
                  Cash Out
                </span>
                ...
                <div
                  ...
                  style={{
                    ...
                    height: 28,
                    borderRadius: 20,
                    background: form.type === 'cash_in' ? '#4caf50' : '#ff4d4f',
                    display: 'flex',
                    alignItems: 'center',
                    padding: 3,
                    cursor: 'pointer',
                ...
                <span
                  style={{
                    fontSize: 12,
                    color: form.type === 'cash_in' ? 'green' : '#888',
                    fontWeight: form.type === 'cash_in' ? 600 : 400,
                  }}
                >
                  Cash In
                </span>
